var app = angular.module('exporter', ['n3-charts.linechart']);
app.factory('ChartExampleData', function() {
  ...
  var options = {
    series: [
      {y: "val_0", label: "A line sinusoid", color: "#1f77b4"},
      {y: "val_0", label: "A column sinusoid", color: "#ff7f0e", type: "column"},
      {y: "val_0", label: "An area sinusoid", color: "#2ca02c", type: "area"}
    ],
    axes: {
      x: {type: "linear", key: "x"},
      y: {type: "linear"}
...
app.controller('ChartCtrl', function ($scope, $http, ChartExampleData) {
  $scope.chart = {
